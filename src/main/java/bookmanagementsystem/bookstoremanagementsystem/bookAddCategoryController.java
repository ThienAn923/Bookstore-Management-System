...
public class bookAddCategoryController implements Initializable {
    @FXML
    private Button addCategoryButton;
    @FXML
    private Button addMoreCategoryButton;
    @FXML
    ...
    private void getCategory() {
        ...
        for (category category : categories) {
            ...
            // Add the HBox for each category to your layout
    ...
    void addCategoryToBook() {
        ...
        bookAddController.getCategories(mainCategory,selectedCategories);
